    ...
    <div className="bg-[#262626] w-[98%] sm:w-[80%] md:w-[70%] xl:w-[35%] px-3 sm:px-6 py-6 sm:py-8 rounded-lg flex flex-col items-center justify-center relative">
      ...
      <div className="flex flex-col justify-center items-center w-full gap-6 px-3 sm:px-5">
        ...
        <div className="flex flex-col gap-4 w-full">
          <div className="rounded-lg bg-[#313131] w-full p-4 flex justify-between items-start sm:items-center gap-3 sm:gap-0">
            <div>
              <h2 className="text-sm text-white mb-1">Recipient receives</h2>
          ...
          <div className="rounded-lg bg-[#313131] w-full p-4 flex flex-col justify-start items-start sm:items-start gap-3 sm:gap-0">
            <h2 className="text-sm text-white mb-1">
              Narration or purpose (Optional)
            </h2>
          ...
          <div className="rounded-lg bg-[#313131] w-full p-4 flex justify-between items-start sm:items-center gap-3 sm:gap-0">
            <p className="text-lg font-semibold text-[#B8B8B8]">
              Payment due date
            </p>
