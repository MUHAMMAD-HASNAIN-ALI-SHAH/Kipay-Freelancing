...
const Transactions = () => {
  ...
  return (
    <div className="w-full xl:flex-row gap-4 pt-5">
      {/* transactions buttons */}
      <div className="flex gap-3">
        <button className="px-6 py-2 font-semibold border rounded-md border-[#4A4A4A] bg-white text-[#4A4A4A]">
          All transactions
        </button>
        <button className="px-6 py-2 font-semibold border rounded-md border-[#4A4A4A]">
          Sent
        </button>
        <button className="px-6 py-2 font-semibold border rounded-md border-[#4A4A4A]">
          Recieved
      ...
      {/* transactions table */}
      <div className="w-full bg-[#262626] rounded-lg p-4 mt-5">
        <Table>
          <TableHeader>
              ...
              >
                <TableCell className="font-medium">
                  <div className="flex items-center gap-2">
                    <div className={`w-10 h-10 text-lg rounded-full flex items-center justify-center ${transaction.color}`}>
                        {transaction.icon}
                    </div>
                    <div>
