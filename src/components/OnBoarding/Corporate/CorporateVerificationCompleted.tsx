const CorporateVerificationCompleted = ({
      ...
      <div className="space-y-2 md:space-y-3 mb-4 w-[90%] md:w-full">
        <button className="flex items-center justify-center gap-5 w-full py-3 px-4 bg-none bg-[#313131] text-white border-none rounded-lg">
          <span className="font-semibold text-sm md:text-xl">
            Begin the process on your phone
          </span>
          <div className="relative">
            <img src="./OnBoarding/phone.png" alt="" />
            <img
              className="absolute top-1/2 bottom-1/2 -translate-y-1/2 translate-x-1/2 rounded-lg"
              src="./OnBoarding/card.png"
              alt=""
            />
            <img
              className="absolute top-1/2 bottom-1/2 -translate-y-11 translate-x-24 md:translate-x-32 rounded-lg max-w-7 min-h-7"
              src="./OnBoarding/tick.png"
              alt=""
            />
            <img
              className="absolute top-1 left-1/2 -translate-x-1/2 rounded-lg"
...
export default CorporateVerificationCompleted;
